...
const dict: Dict = {
  ...
  "reelradar.phaseCollecting": { zh: "收集中…", en: "Collecting…" },
  "reelradar.phaseAnalyzing": { zh: "转文字 + AI 分析中，已分析 {done}/{total}", en: "Transcribing + analyzing, {done}/{total} done" },
  "reelradar.cancelScan": { zh: "取消", en: "Cancel" },
  "reelradar.canCloseTab": { zh: "可以关掉页面，回来会自动接着做", en: "You can close this tab — it'll resume where it left off" },
  ...
  "reelradar.viewGrid": { zh: "▦ 网格", en: "▦ Grid" },
  "reelradar.viewList": { zh: "☰ 列表", en: "☰ List" },
  "reelradar.nowPlaying": { zh: "播放中", en: "Playing" },
  ...
  "reelradar.showLowScore": { zh: "显示低分", en: "Show low scores" },
  "reelradar.hideLowScoreAgain": { zh: "重新隐藏低分", en: "Hide low scores again" },
  "reelradar.captionOnly": { zh: "仅字幕", en: "Caption only" },
  "reelradar.filterLanguage": { zh: "语言", en: "Language" },
  "reelradar.allLanguages": { zh: "全部语言", en: "All Languages" },
  ...
  "reelradar.overviewTitle": { zh: "竞品情报总览", en: "Competitor Intel Overview" },
  "reelradar.scanCostHint": { zh: "一次扫描用一点收集 + AI 分析费，通常不到 RM1", en: "Each scan costs a little for collection + AI analysis — usually under RM1" },
  "reelradar.quickAddTitle": { zh: "贴一条链接，单独分析", en: "Paste one link to analyze it" },
  "reelradar.quickAddDesc": {
    zh: "看到别人一条好 reel？把链接贴进来，雷达会像扫描一样拆解它 — 账号不用在名单里。",
    en: "Spotted a great reel? Paste the link and Radar will break it down the same way a scan would — no need to add the account to your list.",
  },
  "reelradar.quickAddPlaceholder": { zh: "https://www.instagram.com/reel/...", en: "https://www.instagram.com/reel/..." },
  "reelradar.quickAddButton": { zh: "分析", en: "Analyze" },
  "reelradar.quickAddAnalyzing": { zh: "分析中…", en: "Analyzing…" },
  "reelradar.quickAddHint": { zh: "一条大约几分钱", en: "A few cents per link" },
  "reelradar.statPlays": { zh: "播放", en: "plays" },
  "reelradar.statLikes": { zh: "点赞", en: "likes" },
  "reelradar.statComments": { zh: "评论", en: "comments" },

  "reeldetail.back": { zh: "← 雷达", en: "← Radar" },
  "reeldetail.postedOn": { zh: "发布于", en: "Posted" },
  "reeldetail.rewriteExplain": {
    zh: "改写结构 = 借它的骨架，内容全新（最安全，永远可用）· 照搬 = 内容照抄，换成你的语言和语气（适合搬运其他语言市场的内容）· 每次生成约几分钱",
    en: "Rewrite = borrow its skeleton, all-new content (safest, always usable) · Remix = copy the content, swap in your own voice (good for porting content from other-language markets) · a few cents per generation",
  },
  "reeldetail.whyScoredLabel": { zh: "为什么打这个分", en: "Why It Scored" },
  "reeldetail.hookLabel": { zh: "开场", en: "Hook" },
  "reeldetail.structureLabel": { zh: "结构拆解", en: "Structure" },
  "reeldetail.ctaLabel": { zh: "行动召唤", en: "CTA" },
