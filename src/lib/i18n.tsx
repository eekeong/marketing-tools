...
const dict: Dict = {
  ...
  "calendar.viewCalendar": { zh: "日历", en: "Calendar" },
  "calendar.viewList": { zh: "列表", en: "List" },

  "listview.date": { zh: "日期", en: "Date" },
  "listview.titleCol": { zh: "标题", en: "Title" },
  "listview.platformsCol": { zh: "平台", en: "Platforms" },
  "listview.accountCol": { zh: "账号", en: "Account" },
  "listview.adCopyCol": { zh: "广告词", en: "Ad copy" },
  "listview.assetCol": { zh: "素材", en: "Asset" },
  "listview.purposeCol": { zh: "目的", en: "Purpose" },
  "listview.ownerCol": { zh: "负责人", en: "Owner" },
  "listview.statusCol": { zh: "状态", en: "Status" },
  "listview.openLink": { zh: "打开链接", en: "Open link" },
  "listview.empty": { zh: "这个月还没有排程", en: "No posts scheduled this month" },
  ...
  "newpost.editTitle": { zh: "编辑排程", en: "Edit Post" },
  "newpost.save": { zh: "保存修改", en: "Save Changes" },
  ...
  "newpost.accountLabel": { zh: "所属账号", en: "Account" },
  "newpost.accountNone": { zh: "未指定账号", en: "No account" },
  ...
  "newpost.assetLabel": { zh: "素材（链接）", en: "Asset (link)" },
  "newpost.assetPlaceholder": { zh: "贴上素材链接（选填）", en: "Paste a link to the asset (optional)" },
  "newpost.adCopyLabel": { zh: "广告词", en: "Ad copy" },
  "newpost.adCopyPlaceholder": { zh: "给用户看的文案 / CTA（选填）", en: "Copy shown to the audience / CTA (optional)" },
  "newpost.dateLabel": { zh: "发布日期", en: "Publish date" },
  ...
  "cms.tab.accounts": { zh: "账号", en: "Accounts" },
  "cms.accounts.desc": {
    zh: "维护社媒账号/页面名单，新增排程时可以直接选择所属账号。",
    en: "Maintain the list of social accounts/pages here — pick one whenever you create a post.",
  },
  "cms.accounts.nameLabel": { zh: "账号名称", en: "Account name" },
  "cms.accounts.platformLabel": { zh: "平台（选填）", en: "Platform (optional)" },
  "cms.accounts.platformNone": { zh: "未指定", en: "Unspecified" },
  "cms.accounts.empty": { zh: "还没有账号，先在下面新增一个", en: "No accounts yet — add one below" },
  ...
  "detail.deleteConfirm": { zh: "确定删除？", en: "Delete this post?" },
  "detail.deleteConfirmYes": { zh: "确认删除", en: "Confirm" },
  "detail.deleteConfirmNo": { zh: "取消", en: "Cancel" },
  ...
  "setup.reelsPerAccountLabel": {
    zh: "每个竞品/关键词账号每次抓几条（不影响「我的账号」——那边每次都会尽量抓全部）",
    en: "Reels to fetch per competitor/discover account per scan (doesn't affect \"My Account\" — that always tries to fetch everything)",
  },
