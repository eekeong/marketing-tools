...
6. topicTitle：12-18 字以内，一句话概括这支视频具体在讲什么内容/切入点（例如"5分钟历史技巧，快速拿A"、"家长最常犯的3个辅导错误"）——这是给人扫一眼缩略图就知道视频在讲什么的标题，不是钩子原句、不是评价。不管视频原本是英文、马来文还是其他语言，一律用马来西亚道地华文写（马来西亚华人日常说话/打字的用词和语感，比如"考获"、"补习"、"冲刺班"这类在地说法，不是生硬直译，也不是大陆普通话书面语腔调）
